...
const FAQs = () => {
    ...
    return (
        <main className="relative px-[5%] py-[120px] bg-darkpurple grid grid-cols-1 lg:grid-cols-2 items-center justify-between border-b border-1 border-gray-600 overflow-hidden" id="rules">
            <section>
                ...
                <p className="text-md lg:text-lg text-white font-medium font-mon leading-loose text-center lg:text-left">We got answers to the questions that you might</p>
                <p className="text-md lg:text-lg text-white font-medium font-mon leading-loose text-center lg:text-left">want to ask about getlinked Hackathon 1.0</p>

                <div className="relative z-10 w-full mt-10">
                    {faqData.map((item, index) => (
                        <div key={index} className="w-full py-4 lg:py-8 border-b border-b-4 border-purple">
                            ...
                            {expandedIndex === index && (
                                <p className="text-md text-gray-400 font-medium font-mon leading-loose text-justify lg:text-justify leading-relaxed mt-5 pr-4 transition-all duration-500">{item.answer}</p>
                            )}
                        </div>
                    ))}
                </div>
            ...
            <img src="./img/greystar.png" alt="" className="absolute top-[500px] left-[700px] animate-pulse" />
            <img src="./img/litepurplestar.png" alt="" className="absolute top-40 left-[400px] animate-pulse" />
