...
const Hero = () => {
    return (
        <main className="relative grid items-center w-full bg-darkpurple overflow-hidden pt-[90px] bg-matrix bg-cover bg-right bg-no-repeat border-b border-1 border-gray-600" id="home">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 ml-0 md:ml-[5%] relative">
                <div className="z-10 flex flex-col items-center lg:items-start lg:text-left md:text-center">
                    <div className="flex flex-col">
                        ...
                        <h1 className="text-white font-extrabold text-4xl md:text-5xl relative z-1">getlinked Tech</h1>
                    </div>
                    <div className="flex mb-2 md:mb-5">
                        <h1 className="text-white font-extrabold text-4xl md:text-5xl relative z-1">Hackathon <span className="text-purple">1.0</span></h1>
