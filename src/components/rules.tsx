const Rules = () => {
    return ( 
        ...
        <section>
            <h1 className="text-[28px] md:text-4xl text-white font-bold mb-3 text-center lg:text-left">Rules and</h1>
            <h1 className="text-[28px] md:text-4xl text-purple font-bold mb-3 text-center lg:text-left">Guidelines</h1>
            <p className="text-lg text-white font-medium font-mon leading-loose text-center lg:text-left">Our tech hackathon is a melting pot of visionaries, and its purpose is as
