    ...
    return (
        <main className="relative px-[5%] py-[80px] bg-darkpurple border-b border-1 border-gray-600 overflow-hidden" id="terms">
            ...
            <div className="relative z-10 flex flex-col justify-between mb-6 lg:mb-0">
                ...
                <p className="text-[14px] md-text-[16px] text-white font-medium font-mon leading-loose text-left w-full"><span className="border-r-[3px] border-r-purple mr-4 pr-4">Terms of Use </span> <span>Privacy Policy</span></p>
            </div>

            <div className="relative z-10 mb-6 lg:mb-0">
                <h3 className="text-16px md:text-lg text-purple font-medium font-mon leading-loose text-left mb-5 w-full">Useful Links</h3>

                <div className="flex flex-col gap-4 mb-8">
                    <a href="#timeline" className="text-white text-[14px] md:text-[16px] hover:text-pink slow-transition">Timeline</a>
                    <a href="#overview" className="text-white text-[14px] md:text-[16px] hover:text-pink slow-transition">Overview</a>
                    <a href="#faqs" className="text-white text-[14px] md:text-[16px] hover:text-pink slow-transition">FAQs</a>
                    <Link to="/contact" className="text-white text-[14px] md:text-[16px] hover:text-pink slow-transition">Contact</Link>
                </div>

                <div className="relative z-10 flex items-center gap-4">
                    <h3 className="text-purple text-[16px] md:text-lg font-medium">Follow us</h3>
            ...
            <div className="font-mon">
                <h3 className="text-purple text-[16px] md:text-lg font-medium mb-6">Contact Us</h3>
            ...
            <p className="text-[14px] md:text-[16px] text-white font-mon leading-loose text-center w-full">All rights reserved. © getlinked Ltd.</p>
            <p className="text-[14px] md:text-[16px] text-white font-mon leading-loose text-center w-full">Developed by Charles Obimnaetochukwu Egesionu</p>
            </section>
