    ...
    return (
        <main className="relative px-[5%] py-[150px] bg-darkpurple grid grid-cols-1 lg:grid-cols-2 place-items-center border-b border-1 border-gray-600" id="overview">
            ...
            <section className="relative z-10">
                <h1 className="text-[28px] md:text-4xl text-white font-bold mb-0 md:mb-3 text-center lg:text-left" data-aos="fade-down">Introduction to getlinked</h1>
                <h1 className="text-[28px] md:text-4xl text-purple font-bold mb-3 text-center lg:text-left" data-aos="fade-down">tech Hackathon 1.0</h1>
